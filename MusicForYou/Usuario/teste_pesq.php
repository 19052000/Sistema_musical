...
<html lang="pt-br">
    ...
    <body>
        ...
        <?php
           ...
           $url1 = "https://www.youtube.com/results?search_query=melhores+musicas+de+classica";
            if(isset($_POST['enviar'])){
				//$nova_url = $_POST['url'];
				//$url2  = str_replace(" ","+",$nova_url);
				//$novastring = str_replace("aqui",$url2,$url1);
                ...
                var_dump($val4 = explode('<title>',$val3[0]));
